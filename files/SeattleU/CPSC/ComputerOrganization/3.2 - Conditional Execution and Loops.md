...
lli r1 0
lli r2 0
startloop: lli r3 100
	sub r4 r2 r3         # r4 = r2 - 100
	blt r4 &body         # if r4 < 0 go to body:
	beq r0 &endloop
body: add r1 r1 r2;      # sum = sum + i
	addi r2 r2 1
	beq r0 &startloop
endloop: out r1          # displays sum
```

##### Example 2

Convert the following code to ANNA assembly. Assume `a` is in `r2` and `b` is in `r3`.
```C++
int a = 1;
int b = 1;
do {
...
##### In class answers for example 1 and 2

![[Pasted image 20251022114150.png]]